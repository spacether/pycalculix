...
# make model
model_name = 'example3_compr_rotor'
...
model.plot_geometry(model_name+'_geom', pnum=False) # view the geometry
...
for field in fields:
    ...
    rfile.nplot(field, fname, display=disp, gmult=g)
